...
from predictions import children_prediction,children_crimes,children_states,children_years,pred_crime_plot,women_prediction,women_crimes,women_states,women_years,data_pred
...
@app.route('/new_data_pred',methods=['POST','GET'])
def new_data_pred():
	file = request.form.get("myfile")
	score=data_pred(file)
	return render_template('new_data_prediction.html',score_=score)
